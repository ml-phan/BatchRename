...
class ClipListener(threading.Thread):
    ...
    def __init__(self, pause=.5):
        # from documentation: If the subclass overrides the constructor,
    ...
    # override stop method to work with our parameter 'stopping'
    def stop(self):
        self.stopping = True
...
class GUI(tkinter.Frame):
    ...
    def __init__(self, master, ht=600, wt=800):
        ...
        self.pack_propagate(
            False)  # window will use it's own width and height as parameters instead of child's dimensions
        self.pack()
